...
|:--:|
| *The four different dithering modes, dedithering disabled<br>Note to self: Redo this with actual Peach and use APNG* |
...
dithering, but can be used for dithering as well (for example, a TV static effect - another reason why you might not want to run the dedithering filter).
...
| ![peach_dedither.gif]({{ site.baseurl }}/assets/images/peach_dedither.png) |
|:--:|
