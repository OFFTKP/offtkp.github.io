...
- [References \& more reading on the RDP](#references--more-reading-on-the-rdp)
...
Nit: Every depth testing mode except for Decal also passes if `NewZ == 0x3ffff`.
...
## References & more reading on the RDP
