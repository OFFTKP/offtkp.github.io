...
There's another type of dithering, that's called Gamma Dithering. You enable this from the Video Interface and only when Gamma Correction is also enabled. ~~I don't understand gamma dithering enough to explain it yet.~~ It goes out of the scope of this post.
